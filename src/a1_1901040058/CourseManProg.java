...
public class CourseManProg {
  public static void main(String[] args) {
    ...
    Enrolment dongnvSs1Enrolment = new Enrolment(chiendq, ss1, (float) 8.5, (float) 8.5);
    Enrolment nghiantCgrEnrolment = new Enrolment(nghiant, cgr,  8, 9);
    Enrolment dongnvSqaEnrolment = new Enrolment(chiendq, sqa, (float) 8.0, (float) 6.5);
    Enrolment dongnvDbsEnrolment = new Enrolment(dong_nv, dbs,  8,  9);
    Enrolment dongnvMprEnrolment = new Enrolment(nghiant, mpr, (float) 9.5, (float) 7.5);
    Enrolment dongnvReqEnrolment = new Enrolment(nghiant, req, (float) 6.5, (float) 6.5);
    Enrolment phuocntReqEnrolment = new Enrolment(phuocnt, req, (float) 6.5, (float) 6.5);
    Enrolment chienDqDbsEnrolment = new Enrolment(dong_nv, req, (float) 6.5, (float) 6.5);
    Enrolment chienDqWprEnrolment = new Enrolment(dong_nv, req, (float) 6.5, (float) 6.5);
    Enrolment nghiaNtDbsEnrolment = new Enrolment(dong_nv, req, (float) 6.5, (float) 6.5);
    Enrolment phuocNtDbsEnrolment = new Enrolment(dong_nv, req, (float) 6.5, (float) 6.5);
    ...
    manager.addEnrolment(chienDqWprEnrolment);
    ...
    String data = manager.report();
    System.out.println(data);
    System.out.println("sorted!---------------------------------------------------------------------------------------------------");
    manager.sort();
    System.out.println(manager.reportAssessment());
  }
